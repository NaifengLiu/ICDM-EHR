...
embedding_model = word2vec.Word2Vec.load(
    "./data/model_with_feature_selection")
...
read_patient("./data/hae_feature_extraction", positive)
# read_patient("/home/naifeng/Projects/EHR-Deep-Learning/data/nonhae_rx.csv", negative)
# read_patient("/home/naifeng/Projects/EHR-Deep-Learning/data/nonhae_rx.csv", negative)
read_patient("./data/nonhae_sorted_feature_extraction", negative)
...
process_patient_raw_record("./data/hae_feature_extraction")
...
process_patient_raw_record("./data/nonhae_sorted_feature_extraction")
...
print "done loading process_raw_data_with_feature_selection.py"
